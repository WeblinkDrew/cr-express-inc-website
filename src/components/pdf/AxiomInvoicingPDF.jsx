...
const AxiomInvoicingPDF = ({ formData }) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldRow}>
            ...
            <Text style={styles.fieldValue}>{displayValue(formData.loadNumber)}</Text>
          </View>
          <View style={styles.fieldRow}>
            <Text style={styles.fieldLabel}>Load Amount</Text>
            <Text style={styles.fieldValue}>${displayValue(formData.loadAmount)}</Text>
          </View>
        </View>
      </Page>
    </Document>
...
export default AxiomInvoicingPDF;
