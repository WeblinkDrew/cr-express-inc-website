export const article = {
  ...
  description: 'Explore the essential modes of hazardous goods transport, their regulations, safety practices, and logistics solutions for secure delivery.',
  author: {
    name: 'CR Express',
    role: 'Logistics Team',
...
<div className="relative my-10 overflow-hidden rounded-4xl bg-neutral-100 max-sm:-mx-6 aspect-[16/10]">
  <img src="/images/blog-post/Ultimate-Guide-to-Hazardous-Goods-Transport-Modes.jpeg" alt="Ultimate Guide to Hazardous Goods Transport Modes" className="absolute inset-0 h-full w-full object-cover" />
</div>
...
**Quick Comparison**:
    Factor Road Rail Air Sea     **Speed** Moderate Reliable Fastest Slow   **Cost** Varies Low for bulk High Low   **Capacity** Limited High Small Massive   **Flexibility** High Moderate Low Low   **Best For** Domestic Bulk goods Urgent cargo Large loads    
...
<iframe className="sb-iframe" src="https://www.youtube.com/embed/yVqsftLOlvI" loading="lazy" allowFullScreen></iframe>
...
### Transport Mode Comparison Table
    Factor Road (Highway) Rail Air Sea     **Speed** Moderate; effective for domestic shipments Reliable for long-distance shipping Fastest; suited for urgent deliveries Slow; best for international transport   **Cost** Varies by distance and service type Cost effective for bulk loads Premium due to speed and handling Economical per unit   **Capacity** Limited by vehicle weight restrictions High capacity for bulk loads Most limited Very high; handles massive volumes   **Flexibility** Excellent accessibility and routing Moderately flexible Limited by aircraft design Limited by port infrastructure   **Environmental Impact** Moderate, strong last-mile efficiency Lower emissions than road options Highest carbon footprint Very low emissions per ton-mile   **Regulatory Complexity** Straightforward compliance Higher due to multiple agencies Stringent and highly regulated High, with international standards   **Best For** Flexible domestic deliveries Bulk shipments over long distances High-value or emergency cargo Large-scale international shipments    
