export const article = {
  ...
  description: 'Explore common warehouse delays and effective solutions to streamline operations, reduce costs, and enhance customer satisfaction.',
  author: {
    name: 'CR Express',
    role: 'Logistics Team',
...
<div className="relative my-10 overflow-hidden rounded-4xl bg-neutral-100 max-sm:-mx-6 aspect-[16/10]">
  <img src="/images/blog-post/Warehouse-Delays-7-Common-Causes-and-Solutions.jpg" alt="Warehouse Delays: 7 Common Causes and Solutions" className="absolute inset-0 h-full w-full object-cover" />
</div>
