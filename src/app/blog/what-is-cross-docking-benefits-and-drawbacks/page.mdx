export const article = {
  ...
  description: 'Cross-docking is a logistics method where goods are transferred directly from incoming to outgoing transportation with minimal storage time',
  author: {
    name: 'CR Express',
    role: 'Logistics Team',
...
![What is Cross-Docking? Benefits and Drawbacks](https://crexpressinc.com/wp-content/uploads/2025/10/image_d7be47665273f444cfd27e98a0aac828.jpeg)
...
[Watch Video](https://www.youtube.com/embed/qer8SWKx2mI)
## Conclusion
