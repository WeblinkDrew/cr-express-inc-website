export const article = {
  ...
  description: 'Container drayage is a key part of the supply chain, ensuring goods move efficiently between ports, rail yards, warehouses, and distribution centers',
  author: {
    name: 'CR Express',
    role: 'Logistics Team',
...
![Complete Guide to Container Drayage Services](https://crexpressinc.com/wp-content/uploads/2025/09/image_5fa720e60c67e52e5e975372f5ba8c46.jpeg)
...
[Watch Video](https://www.youtube.com/embed/LpZfcIei3RM)
...
| Feature | Port Drayage | Intra-Carrier Drayage |
| --- | --- | --- |
| **Movement** | From ports to nearby warehouses or rail terminals | Within a single carrier's network |
| **Purpose** | Quickly move goods inland to reduce port congestion | Optimize internal logistics operations |
| **Typical Distance** | Local area | Varies within the carrier's service area |
| **Coordination** | May require multiple carriers | Managed entirely by one carrier |
...
| Service Category | Pricing Model | Key Features | Considerations |
| --- | --- | --- | --- |
| Standard Logistics Services | Custom Pricing | Airport transfers, container drayage, FTL/LTL shipping, TSA-approved transportation | Pricing depends on shipment details and fuel surcharge |
| Warehousing Solutions | Custom Pricing | 280,000 sq ft warehouse, hazardous materials handling, secured yard space | Availability may vary based on storage needs |
| Specialized Transportation | Custom Pricing | Certified hazardous materials handling, temperature-controlled storage | Requires detailed shipment specifications |
