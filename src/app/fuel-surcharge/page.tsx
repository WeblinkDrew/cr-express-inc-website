...
const airportSurchargeData = [
  { range: '$1.200-$1.449', percentage: '15.50%' },
  { range: '$1.450-$1.699', percentage: '16.00%' },
  { range: '$1.700-$1.949', percentage: '16.50%' },
  { range: '$1.950-$2.199', percentage: '17.00%' },
  { range: '$2.200-$2.449', percentage: '17.50%' },
  { range: '$2.450-$2.699', percentage: '18.00%' },
  { range: '$2.700-$2.949', percentage: '18.50%' },
  { range: '$2.950-$3.199', percentage: '19.00%' },
  { range: '$3.200-$3.449', percentage: '19.50%' },
  { range: '$3.450-$3.699', percentage: '20.00%' },
  { range: '$3.700-$3.949', percentage: '20.50%' },
  { range: '$3.950-$4.199', percentage: '21.00%' },
  { range: '$4.200-$4.449', percentage: '21.50%' },
  { range: '$4.450-$4.699', percentage: '22.00%' },
  { range: '$4.700-$4.949', percentage: '22.50%' },
  { range: '$4.950-$5.199', percentage: '23.00%' },
  { range: '$5.200-$5.449', percentage: '23.50%' },
  { range: '$5.450-$5.699', percentage: '24.00%' },
  { range: '$5.700-$5.949', percentage: '24.50%' },
  { range: '$5.950-$6.199', percentage: '25.00%' },
  { range: '$6.200-$6.449', percentage: '25.50%' },
  { range: '$6.450-$6.699', percentage: '26.00%' },
  { range: '$6.700-$6.949', percentage: '26.50%' },
  { range: '$6.950-$7.199', percentage: '27.00%' },
]

const railSurchargeData = [
  { range: '$1.200-$1.449', percentage: '24.00%' },
  { range: '$1.450-$1.699', percentage: '26.00%' },
  { range: '$1.700-$1.949', percentage: '28.00%' },
  { range: '$1.950-$2.199', percentage: '30.00%' },
  { range: '$2.200-$2.449', percentage: '32.00%' },
  { range: '$2.450-$2.699', percentage: '34.00%' },
  { range: '$2.700-$2.949', percentage: '36.00%' },
  { range: '$2.950-$3.199', percentage: '38.00%' },
  { range: '$3.200-$3.449', percentage: '40.00%' },
  { range: '$3.450-$3.699', percentage: '42.00%' },
  { range: '$3.700-$3.949', percentage: '44.00%' },
  { range: '$3.950-$4.199', percentage: '46.00%' },
  { range: '$4.200-$4.449', percentage: '48.00%' },
  { range: '$4.450-$4.699', percentage: '50.00%' },
  { range: '$4.700-$4.949', percentage: '52.00%' },
  { range: '$4.950-$5.199', percentage: '54.00%' },
  { range: '$5.200-$5.449', percentage: '56.00%' },
  { range: '$5.450-$5.699', percentage: '58.00%' },
  { range: '$5.700-$5.949', percentage: '60.00%' },
  { range: '$5.950-$6.199', percentage: '62.00%' },
  { range: '$6.200-$6.449', percentage: '64.00%' },
  { range: '$6.450-$6.699', percentage: '66.00%' },
  { range: '$6.700-$6.949', percentage: '68.00%' },
  { range: '$6.950-$7.199', percentage: '70.00%' },
]
